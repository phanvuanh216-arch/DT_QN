  ...
  <div class="page">
    ...
    <div class="content">
      <div class="info-row">
        ...
        <div class="info-card"><div class="label">🌱 Đối tượng nông nghiệp</div><div class="value">{", ".join(crops) if crops else "—"}</div></div>
    ...
    <div class="footer-note">Bản tin được tạo tự động từ hệ thống Bản tin Khí hậu Quảng Ninh — phiên bản 1.3.6</div>
  </div>
</body></html>"""
...
def page_ban_tin_xa():
    ...
    with col2:
        ...
        with sub_label: st.markdown(f"**🌾 Đối tượng:** {', '.join(crops)}")
        with sub_btn:
